"""
Django settings for Criminal_Tracker_Face_Detection project.
...
ROOT_URLCONF = 'Criminal_Tracker_Face_Detection.urls'
...
WSGI_APPLICATION = 'Criminal_Tracker_Face_Detection.wsgi.application'
