...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'E:\Codebook\backup\passsport_verification\pvenv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'E:\Codebook\backup\passsport_verification\pvenv\Scripts\deactivate.nu'
